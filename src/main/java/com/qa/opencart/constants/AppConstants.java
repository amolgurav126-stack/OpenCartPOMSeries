...
public class AppConstants {
	...
	public static final int FOOTER_LINKS_COUNT = 16;
	...
	public static final String LOGIN_BLANK_CREDS_ERROR_MESSG = "Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour.";
